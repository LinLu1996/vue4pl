  ...
  >
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getSearchDataList()">
      <el-row>
        <el-col :span="6">
          <el-form-item>
            <el-input v-model="dataForm.type" placeholder="委托方名称" maxlength="20" clearable style="width: 100%;"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="6">
          <el-form-item>
            <el-input v-model="dataForm.typeName" placeholder="委托方编码" maxlength="16" clearable style="width: 100%;"></el-input>
          </el-form-item>
        </el-col>
