  ...
  <el-dialog
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="100px">
      ...
      <el-row>
        ...
        <el-col :span="24">
          <el-form-item label="温区：" prop="tempMode">
            <span style="width: 90%; display: inline-block">
                {{dataForm.warmAreaName}}
            </span>
          </el-form-item>
        </el-col>
        <el-col :span="24">
  ...
  export default {
    data () {
      return {
        ...
        outputConfig: {
          id: '',
          outputUrl: '/transresources/trproduct/outPutExcelAnnex',
          fileName: '运输产品附件'
        }
      }
    },
          ...
          if (this.dataForm.id) {
            ...
            this.$http({
              ...
              if (data && data.code === 0) {
                ...
                this.dataForm.warmAreaName = data.tTrProduct.warmAreaName
