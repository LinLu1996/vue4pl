<template>
  <div>
    <div id="myChartBar2" style="width:100%;height: 400px;margin: 0 auto"></div>
  </div>
</template>
<script>
  ...
  export default {
    ...
    methods: {
      init (data) {
        ...
        let yData = []
        data.map(res => {
          xData.push(res.number)
          yData.push(res.consignorName)
        })
      ...
      drawBar1 (xData, yData) {
        var myChartBar2 = echarts.init(document.getElementById('myChartBar2'))
        let options = []
