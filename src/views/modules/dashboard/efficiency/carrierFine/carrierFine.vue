<template>
  <div>
    ...
    <div  class="module-wrap">
      <div id="myChartCarrier" style="width:100%;height: 18rem;margin: 0 auto"></div>
    </div>
  </div>
</template>
<script>
      ...
      init () {
        ...
        this.$http({
          ...
          if (data && data.code === 0) {
            ...
            const tkpiAssessmentRecordMonthList = datas.fsFineMonthList || []
